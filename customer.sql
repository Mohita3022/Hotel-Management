...
create table customer(document varchar(20), number varchar(30), name varchar(30), gender varchar(15), country varchar(20), room varchar(10), checkintime varchar(80), deposit varchar(20)roomcustomerroomloginroomroomroomcustomercustomer);
...
select * from department;category_infospendingsspendingscustomercustomercustomerdocumentdepartmentcustomer
